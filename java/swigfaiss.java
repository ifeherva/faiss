...
public class swigfaiss {
  ...
  public static void hammings_knn_core(int_maxheap_array_t ha, SWIGTYPE_p_unsigned_char a, SWIGTYPE_p_unsigned_char b, long nb, long ncodes) {
    swigfaissJNI.hammings_knn_core(int_maxheap_array_t.getCPtr(ha), ha, SWIGTYPE_p_unsigned_char.getCPtr(a), SWIGTYPE_p_unsigned_char.getCPtr(b), nb, ncodes);
  }
  ...
  public static void generalized_hammings_knn(int_maxheap_array_t ha, SWIGTYPE_p_unsigned_char a, SWIGTYPE_p_unsigned_char b, long nb, long code_size, int ordered) {
    swigfaissJNI.generalized_hammings_knn__SWIG_0(int_maxheap_array_t.getCPtr(ha), ha, SWIGTYPE_p_unsigned_char.getCPtr(a), SWIGTYPE_p_unsigned_char.getCPtr(b), nb, code_size, ordered);
  }

  public static void generalized_hammings_knn(int_maxheap_array_t ha, SWIGTYPE_p_unsigned_char a, SWIGTYPE_p_unsigned_char b, long nb, long code_size) {
    swigfaissJNI.generalized_hammings_knn__SWIG_1(int_maxheap_array_t.getCPtr(ha), ha, SWIGTYPE_p_unsigned_char.getCPtr(a), SWIGTYPE_p_unsigned_char.getCPtr(b), nb, code_size);
  }
  ...
  public static Index downcast_index(Index arg0) {
    long cPtr = swigfaissJNI.downcast_index((arg0 == null) ? 0 : arg0.Index_GetInterfaceCPtr(), arg0);
    return (cPtr == 0) ? null : (Index)new IndexSwigImpl(cPtr, false);
  }
  ...
  public static void write_index(Index idx, SWIGTYPE_p_FILE f) {
    swigfaissJNI.write_index__SWIG_0((idx == null) ? 0 : idx.Index_GetInterfaceCPtr(), idx, SWIGTYPE_p_FILE.getCPtr(f));
  }

  public static void write_index(Index idx, String fname) {
    swigfaissJNI.write_index__SWIG_1((idx == null) ? 0 : idx.Index_GetInterfaceCPtr(), idx, fname);
  }
  ...
  public static Index read_index(SWIGTYPE_p_FILE f, int io_flags) {
    long cPtr = swigfaissJNI.read_index__SWIG_0(SWIGTYPE_p_FILE.getCPtr(f), io_flags);
    return (cPtr == 0) ? null : (Index)new IndexSwigImpl(cPtr, false);
  }

  public static Index read_index(SWIGTYPE_p_FILE f) {
    long cPtr = swigfaissJNI.read_index__SWIG_1(SWIGTYPE_p_FILE.getCPtr(f));
    return (cPtr == 0) ? null : (Index)new IndexSwigImpl(cPtr, false);
  }

  public static Index read_index(String fname, int io_flags) {
    long cPtr = swigfaissJNI.read_index__SWIG_2(fname, io_flags);
    return (cPtr == 0) ? null : (Index)new IndexSwigImpl(cPtr, false);
  }

  public static Index read_index(String fname) {
    long cPtr = swigfaissJNI.read_index__SWIG_3(fname);
    return (cPtr == 0) ? null : (Index)new IndexSwigImpl(cPtr, false);
  }
  ...
  public static ProductQuantizer read_ProductQuantizer(String fname) {
    long cPtr = swigfaissJNI.read_ProductQuantizer(fname);
  ...
  public static void write_ProductQuantizer(ProductQuantizer pq, String fname) {
    swigfaissJNI.write_ProductQuantizer(ProductQuantizer.getCPtr(pq), pq, fname);
  }

  public static Index clone_index(Index arg0) {
    long cPtr = swigfaissJNI.clone_index((arg0 == null) ? 0 : arg0.Index_GetInterfaceCPtr(), arg0);
    return (cPtr == 0) ? null : (Index)new IndexSwigImpl(cPtr, false);
  }
  ...
  public static Index index_factory(int d, String description, MetricType metric) {
    ...
    return (cPtr == 0) ? null : (Index)new IndexSwigImpl(cPtr, true);
  }
